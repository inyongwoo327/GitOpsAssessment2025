...
MASTER_IP="10.0.1.82"
K3S_TOKEN="K10c3b70698d4dfe923739b30df2ec972e9a476d2c33c84423c67a737064d7dbc5e::server:f3227b63d630600ee5ada33046c9efc6"
...
for i in {1..5}; do
    ...
    curl -sfL https://get.k3s.io | K3S_URL="https://10.0.1.82:6443" K3S_TOKEN="K10c3b70698d4dfe923739b30df2ec972e9a476d2c33c84423c67a737064d7dbc5e::server:f3227b63d630600ee5ada33046c9efc6" sh - && {
        ...
        if [ $i -eq 5 ]; then
            ...
            K3S_URL="https://10.0.1.82:6443" K3S_TOKEN="K10c3b70698d4dfe923739b30df2ec972e9a476d2c33c84423c67a737064d7dbc5e::server:f3227b63d630600ee5ada33046c9efc6" /tmp/install-k3s.sh
        fi
    }
done
